...
def _generate_room_code(teacher_id, student_id):
...
def telemed_start(consultation_id):
    ...
    try:
        ...
        student_id = row['student_id']
        room_code = _generate_room_code(teacher_id, student_id)
...
def telemed_join(consultation_id):
    ...
    # Check authorization
    if user_id != consultation.get('teacher_id') and user_id != consultation.get('student_id'):
